...
#ifndef _OpenAPI_sm_message_type_H_
#define _OpenAPI_sm_message_type_H_
...
typedef struct OpenAPI_sm_message_type_s OpenAPI_sm_message_type_t;
typedef struct OpenAPI_sm_message_type_s {
} OpenAPI_sm_message_type_t;
...
#endif /* _OpenAPI_sm_message_type_H_ */
