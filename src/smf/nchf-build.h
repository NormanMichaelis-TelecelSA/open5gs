...
/* TS 32.291 Nchf_ConvergedCharging uses API version v3 */
#define OGS_SBI_API_V3                              "v3"

/* TS 32.291 resource name for Nchf_ConvergedCharging */
#define OGS_SBI_RESOURCE_NAME_CHARGING_DATA "chargingdata"
